...
function explanation(mnemonic) {
  ...
  if (format == "R" || format == "NULL") {
    if (mnemonic.mnemonic == "break" || mnemonic.mnemonic == "syscall") {
      explain += `
        <table style="width: 100%; border: 2px solid #5f3c9180; font-size: 1.2vw; table-layout: fixed;">
          <tr><th>op</th><th colspan="4">code</th><th>funct</th></tr>
          <tr><td>6-bit</td><td colspan="4">20-bit</td><td>6-bit</td></tr>
        </table>
        <div style="text-align: left; font-size: 0.95vw; margin-top: 0.75rem;">
          ...
          <li><strong>code:</strong> Custom code (20 bits)</li>
    ...
    explain += `
      <table style="width: 100%; border: 2px solid #5f3c9180; font-size: 1.2vw; table-layout: fixed;">
        ...
        <tr><td>6-bit</td><td colspan="5">26-bit</td></tr>
      </table>
      <div style="text-align: left; font-size: 1vw; margin-top: 0.75rem;">
        <li><strong>op:</strong> Opcode (specifies the operation type) (6 bits)</li>
