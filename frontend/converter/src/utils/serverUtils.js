export function checkUndefined(val, binary) {
  if (val !== undefined) {
    return "wrong";
  }
  return binary;
...
export function registerBin(name, registers) {
...
export function checkValue(registers, mipsArray) {
  let v = [];
...
export function convertValue(mnemonic, values) {
  let v = [];
